...
wp core install --url=your_website_url --title="9irsh" --admin_user=$_WORDPRESS_DB_USER --admin_password=$_WORDPRESS_DB_PASSWORD --admin_email=$_WORDPRESS_EMAIl --allow-root
wp user create $_WP_CLI_USER $_WP_CLI_EMAIL --user_pass=$_WP_CLI_PASSWORD
php-fpm7.3 -F -R
